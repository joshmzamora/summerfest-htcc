...
export default function WhatToExpectPage() {
  return (
    <main className="what-to-expect-page">
      ...
      <Section
        title="Introduction"
        description="A quick look at the atmosphere and festival energy guests can expect on the grounds."
      >
        <article className="highlight-panel admission-panel experience-intro-panel">
          <div className="admission-panel-header">
            <h3>Come ready for a real parish festival day</h3>
            <p>{siteContent.whatToExpect.intro.welcome}</p>
          </div>
        </article>
      </Section>
      ...
      <Section title={siteContent.whatToExpect.pricing.title} description={siteContent.whatToExpect.pricing.description}>
